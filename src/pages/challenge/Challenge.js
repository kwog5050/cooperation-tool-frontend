...
import SideMenu from 'components/sideMenu/challenge/SideMenu';
        ...
        <>
            ...
            <Style.Container width={containerSize}>
                <div className="top">
                    ...
                    <div className="checkBox">
                        <ul>
                            <li>
                                <button>
                                    <img src={cooperationImage.challengeCheckOn} alt="" />
                                </button>
                                <span>전체</span>
                            </li>
                            <li>
                ...
                <div className="list">
                    <ul>
                        <li className='end'>
                            <Link to={"/cooperation/challenge/1"}>
                                <div className="subTitle">
                                    <h5>송별회(퇴사)</h5>
                                    <strong>100 <img src={cooperationImage.coin} alt="" /></strong>
                                </div>
                                ...
                                <div className="info">
                                    <div className="members">
                                        <img src={cooperationImage.challengeMember} alt="" />
                                        <span>7/26명</span>
                                    </div>
                                    <div className="situation">
                                        <img src={cooperationImage.challengeDate} alt="" />
                                        <span>종료</span>
                                    </div>
                                </div>
                            </Link>
