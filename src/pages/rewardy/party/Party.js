...
import SideMenu from 'components/rewardy/sideMenu/party/SideMenu';
                ...
                <div className="top">
                    ...
                    <div className="tap">
                        <button className="userParty">
                            <img src={rewardyImage.challengeCheckOff} alt="" />
                            <span>내 파티(4)</span>
                        </button>
                        ...
                        <div>
                            ...
                            <div className="sort">
                                <button className='on'>
                                    <img src={rewardyImage.partySort01_on} alt="" />
                                </button>
                                <button>
                                    <img src={rewardyImage.partySort02_off} alt="" />
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <li>
                            <Link>
                                <div className="day">
                                    ...
                                    <button><img src={rewardyImage.partyStar_on} alt="" /></button>
                                </div>
