...
const CapabilityPopup = ({ setIsCapabilityPopup }) => {
    return (
        <Style.Container>
            <div className="box">
                <img onClick={() => { setIsCapabilityPopup(false) }} src={rewardyImage.close2} alt="" />
                <h3>역량</h3>
                ...
                <div className="status">
                    ...
                    <div className="chart">
                        ...
                        <img src={rewardyImage.rank} alt="" />
                    </div>
                </div>

                <div className="send">
                    <button><img src={rewardyImage.liveHeart} alt="" /> 좋아요 보내기</button>
                    <button><img src={rewardyImage.liveCoin} alt="" /> 코인 보내기</button>
                    <button><img src={rewardyImage.liveMes} alt="" /> 쪽지 보내기</button>
                </div>
            </div>
